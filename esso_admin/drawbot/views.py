...
blueprint = Blueprint('drawbot', __name__, static_folder='../static')
...
def drawbot():
    ...
    return render_template('drawbot/drawbot.html', pg_files=pg_files, form=form)
...
def action(action_id, file=None):
    ...
    return redirect(url_for('drawbot.drawbot'))
